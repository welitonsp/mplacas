...
_NAVY = colors.HexColor(theme.NAVY_HEX)
_LIGHT_BLUE = colors.HexColor(theme.LIGHT_BLUE_HEX)
_LIGHT_GRAY = colors.HexColor(theme.LIGHT_GRAY_HEX)
_MID_GRAY = colors.HexColor(theme.MID_GRAY_HEX)
_DARK = colors.HexColor(theme.DARK_HEX)
_WHITE = colors.white
