...
async def _process_task(task_id: uuid.UUID) -> None:
    ...
    # Sem object storage configurado (ADR-076), os bytes ficam no banco e o
    # download é servido pelo endpoint da própria API. `artifact_url` só volta a
    # ser preenchido quando existir um ArtifactStorage devolvendo URL https —
    # ver a nota em reports/storage.py.
